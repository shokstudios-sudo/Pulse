-- Pulse Monitor - MySQL Database Schema
-- Import with: mysql -u root -p pulse_monitor < schema.sql

CREATE DATABASE IF NOT EXISTS pulse_monitor CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE pulse_monitor;
